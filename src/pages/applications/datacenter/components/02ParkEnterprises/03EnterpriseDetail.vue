        ...
        <div v-if="visble_bascinfo" style="padding-top: 20px">
          <a-row :gutter="24">
            <a-col :span="4" style="text-align: end" class="logo_s">
              <img
                :src="
                  bascform.logo&&bascform.logo.length&&bascform.logo[0].url
                    ? bascform.logo[0].url
                ...
                <span slot="title">
                  <a-tag
                    :color="
                      getcolor(
                        statuslist,
                        bascform.industry&&bascform.industry.length ? bascform.industry[0] : '',
                        'status'
                      )
                    "
                    >{{
        ...
        <div v-else style="margin-top: 20px">
          ...
          >
            <a-row>
              ...
              <a-col :span="12">
                <a-form-model-item class="fontsize_label" prop="oneIndustry">
...
export default {
  ...
  created() {
    ...
    this.id = this.params.record || undefined;
    this.init();
  },
  methods: {
    upLoadChange(info) {
      ...
      this.$refs.businessform.validate((valid) => {
        if (valid) {
          var datas = Object.assign(this.businessform, {
            oneIndustry: this.businessform.oneIndustry.join(","),
            company: this.id,
            comeform: "PC端",
          });
    ...
    changes() {
      this.$forceUpdate();
      // this.businessform.oneIndustry = e
    },
    onclicks(e) {
