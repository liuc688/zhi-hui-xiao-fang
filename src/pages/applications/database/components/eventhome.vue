      ...
      <a-row>
        <a-col :md="8" :sm="24">
          ...
          >
            ...
            >
                <a-select-option v-for="item in eventlist" :key="item.id" >
                {{ item.name }}
                </a-select-option>
            </a-select>
          </a-form-model-item>
...
export default {
  ...
  data() {
    return {
      ...
      eventlist: [
        { id: 0, name: "结束", color: "#2db7f5" },
        { id: 1, name: "处理中", color: "#ff9800" },
        { id: 2, name: "暂停", color: "#87d068" },
      ],
      columns: [
        {
          title: "地址名称",
  ...
  methods: {
    ...
    loadDataSrouce() {
      event_paginate(this.searchform)
        .then((res) => {
