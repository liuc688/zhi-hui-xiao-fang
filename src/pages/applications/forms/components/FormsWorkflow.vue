  ...
  <div>
    ...
    <div>
      <a-space class="operator">
        <a-button @click="onAdd" type="primary" v-auth="`forms.workflow.add`"
          >新建</a-button
        >
        <a-dropdown>
          <a-menu slot="overlay">
      ...
      <standard-table
        ...
        @change="onChange"
        :rowKey="'id'"
        v-auth="`forms.workflow.paginate`"
...
import { workflow_paginate, form_delete } from "@/services/forms";
export default {
  name: "FormsWorkflow",
  ...
  authorize: {
    onAdd: "forms.workflow.add",
    onEdit: "forms.workflow.edit",
  ...
  methods: {
    ...
    paginate() {
      workflow_paginate(Object.assign(this.pagination, this.searchForm))
        .then((res) => {
          this.loading = false;
