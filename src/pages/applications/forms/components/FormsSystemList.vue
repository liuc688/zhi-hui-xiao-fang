  ...
  <div>
    ...
    <div>
      <a-space class="operator">
        <a-button @click="onAdd" type="primary" v-auth="`forms.system.add`"
          >新建</a-button
        >
        <a-dropdown>
          <a-menu slot="overlay">
      ...
      <a-pagination
        ...
        :current="pagination.page" :defaultPageSize="pagination.per_page"
        @change="onChangePage"
...
import { system_paginate, form_delete } from "@/services/forms";
export default {
  name: "FormsList",
  ...
  authorize: {
    onAdd: "forms.system.add",
    onEdit: "forms.system.edit",
  ...
  methods: {
    ...
    paginate() {
      system_paginate(Object.assign(this.pagination, this.searchForm))
        .then((res) => {
          this.loading = false;
