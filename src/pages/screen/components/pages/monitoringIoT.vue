              ...
              <div style="display: flex; justify-content: center; align-items: center; width: 100%">
                <div style="width: 100%">
                  <div style="width: 100%; text-align: center">
                    <img src="./images/sys_jiance1.png" alt="" v-if="item.stutas" style="width: 34px; height: 41px" />
                    <img src="./images/sys_jiance.png" alt="" v-else style="width: 34px; height: 41px" />
                    <div :style="{ color: item.stutas ? '#778391' : '#e5953c', marginTop: '5px' }">{{ item.stutas ? '离线' : '报警' }}</div>
                  </div>
                  <div class="shebei_xq">
...
export default {
  ...
  data() {
    return {
      datasource: [
        { name: '火焰识别', number: '11233875111908', type: '火焰识别摄像机', adress: '展厅', stutas: false },
        { name: '火焰识别', number: '11233875111907', type: '火焰识别摄像机', adress: '展厅4', stutas: true },
        { name: '11233311198652', number: '11233875111906', type: '火焰识别摄像机', adress: '展厅3', stutas: true },
        { name: '11233311198653', number: '11233875111905', type: '火焰识别摄像机', adress: '展厅2', stutas: true },
        { name: '11233311198654', number: '11233875111904', type: '火焰识别摄像机', adress: '展厅1', stutas: true },
      ],
    };
  },
  mounted() {
