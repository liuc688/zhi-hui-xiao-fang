              ...
              <div style="display: flex; justify-content: center; align-items: center; width: 100%">
                <div style="width: 100%">
                  <div style="width: 100%; text-align: center">
                    <img src="./images/sys_water1.png" alt="" v-if="item.stutas" style="width: 37px; height: 38px" />
                    <img src="./images/sys_water.png" alt="" v-else style="width: 37px; height: 38px" />
...
export default {
  ...
  data() {
    return {
      datasource: [
        { name: '11233311198650', number: '11233875111908', type: '消防水池', adress: '展厅', stutas: false },
        { name: '11233311198651', number: '11233875111907', type: '消防水池', adress: '展厅4', stutas: true },
        { name: '11233311198652', number: '11233875111906', type: '消防水池', adress: '展厅3', stutas: true },
        { name: '11233311198653', number: '11233875111905', type: '消防水池', adress: '展厅2', stutas: true },
        { name: '11233311198654', number: '11233875111904', type: '消防水池', adress: '展厅1', stutas: true },
      ],
    };
  },
  mounted() {
