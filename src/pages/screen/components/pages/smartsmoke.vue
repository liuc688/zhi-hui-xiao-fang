              ...
              <div style="display: flex; justify-content: center; align-items: center; width: 100%">
                <div style="width: 100%">
                  <div style="width: 100%; text-align: center">
                    <img src="./images/sys_smock1.png" alt="" v-if="item.stutas" style="width: 40px; height: 38px" />
                    <img src="./images/sys_smock.png" alt="" v-else style="width: 40px; height: 38px" />
                    <div :style="{ color: item.stutas ? '#778391' : '#e5953c', marginTop: '5px' }">报警</div>
                  </div>
                  <div class="shebei_xq">
                    ...
                    <div>电量：100%</div>
                    <div>更新时间：2022-12-28 09:26:59</div>
                  </div>
...
export default {
  ...
  data() {
    return {
      datasource: [
        { name: '11233311198650', number: '11233875111908', type: '可燃气体检测', adress: '展厅', stutas: false },
        { name: '11233311198651', number: '11233875111907', type: '可燃气体检测', adress: '展厅4', stutas: true },
        { name: '11233311198652', number: '11233875111906', type: '可燃气体检测', adress: '展厅3', stutas: true },
        { name: '11233311198653', number: '11233875111905', type: '可燃气体检测', adress: '展厅2', stutas: true },
        { name: '11233311198654', number: '11233875111904', type: '可燃气体检测', adress: '展厅1', stutas: true },
      ],
    };
  },
  mounted() {
