              ...
              <div style="display: flex; justify-content: center; align-items: center; width: 100%">
                <div style="width: 100%">
                  <div style="width: 100%; text-align: center">
                    <img src="./images/sys_baojing1.png" alt="" v-if="item.stutas" style="width: 42px; height: 38px" />
                    <img src="./images/sys_baojing.png" alt="" v-else style="width: 42px; height: 38px" />
