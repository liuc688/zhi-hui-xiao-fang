              ...
              <div style="display: flex; justify-content: center; align-items: center; width: 100%">
                <div style="width: 100%">
                  <div style="width: 100%; text-align: center">
                    <img src="./images/sys_miehuo1.png" alt="" v-if="item.stutas" style="width: 36px; height: 39px" />
                    <img src="./images/sys_miehuo.png" alt="" v-else style="width: 36px; height: 39px" />
                    <div :style="{ color: item.stutas ? '#778391' : '#e5953c', marginTop: '3px' }">报警</div>
                  </div>
                  <div class="shebei_xq">
