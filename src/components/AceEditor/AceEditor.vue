<template>
	<div class="wrap h-100"><div class="w-100 code-editor" :ref="generateId"></div></div>
</template>
<script>
// 引入全局实例
...
ace.config.setModuleUrl('ace/snippets/javascript', require('file-loader!ace-builds/src-noconflict/snippets/javascript.js'));
ace.config.setModuleUrl('ace/snippets/css', require('file-loader!ace-builds/src-noconflict/snippets/css.js'));
ace.config.setModuleUrl('ace/snippets/html', require('file-loader!ace-builds/src-noconflict/snippets/html.js'));
ace.config.setModuleUrl('ace/snippets/django', require('file-loader!ace-builds/src-noconflict/snippets/django.js'));
// 插件
